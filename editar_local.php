...
<body>
    ...
    <form action="atualizar_local.php" method="POST">
        ...
        <div class="form-group">
            <label for="nomeDoResponsavelpeloLocal">Nome do Responsável:</label><br>
            <input type="text" id="nomeDoResponsavelpeloLocal" name="nomeDoResponsavelpeloLocal" value="<?php echo $local['nomeDoResponsavelpeloLocal']; ?>"><br><br>
        </div>
